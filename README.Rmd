...
After installation of the PRISM package, first try out whether you can connect to the remote. If you have not yet set up an SSH key and uploaded it to the remote, you will be asked for password.
```{r test, eval=FALSE}
...
On Windows, you will first need to install [Git bash](https://gitforwindows.org/).
